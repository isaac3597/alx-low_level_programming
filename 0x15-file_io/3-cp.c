...
/**
 * create_buffer - It will allocate the 1024 bytes for a buffer.
 ...
 *  @fd: This is the file to be closed.
 */
void close_file(int fd)
{
	int c;
...
/**
 * main - It copies the file to another.
 * @argc: This is the number of arguments that supplies to the program.
 * @argv: This is the array of pointers to the arguments.
 *
 * Return: 0 on success.
 *
 * Description: If the argument incorrect - exit code 97.
